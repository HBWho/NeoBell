...
class DeviceBloc extends Bloc<DeviceEvent, DeviceState> {
  ...
  Future<void> _onLoadDevices(
    ...
    result.fold(
      (failure) => emit(DeviceFailure(failure.message)),
      (devices) {
  ...
  Future<void> _onLoadDeviceDetails(
      LoadDeviceDetails event, Emitter<DeviceState> emit) async {
    emit(DeviceLoading());
  ...
  Future<void> _onLoadDeviceUsers(
      LoadDeviceUsers event, Emitter<DeviceState> emit) async {
    emit(DeviceLoading());
  ...
  Future<void> _onAddUserToDevice(
      AddUserToDevice event, Emitter<DeviceState> emit) async {
    emit(DeviceLoading());
  ...
  Future<void> _onRemoveUserFromDevice(
      RemoveUserFromDevice event, Emitter<DeviceState> emit) async {
    emit(DeviceLoading());
