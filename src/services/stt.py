...
class STTService():
    ...
    def load_model(self):
        try:
            ...
            print(f"Error loading Vosk STT model from {self.model_path}: {e}")
            self.stt_model = None
    ...
    def transcribe_audio(self, duration_seconds=7):
        ...
        print(f"Attempting to listen for {duration_seconds} seconds on device ID: {self.device_id} using sounddevice...")
        ...
        try:
            ...
            print(f"Recording started on device {self.device_id}. Listening...")
            ...
            print(f"Error during sounddevice recording or processing on device {self.device_id}: {e}")
