...
# --- Configurações do Dispositivo SBC (SUBSTITUA ESTES VALORES) ---
SBC_ID = "NeoBellSBC-Device-IaC-01"  # Ou o ClientID/ThingName do seu dispositivo de teste
AWS_IOT_ENDPOINT = "YOUR_AWS_IOT_ENDPOINT"  # Ex: a123abcdef45gh.iot.us-east-1.amazonaws.com
PATH_TO_ROOT_CA = "certs/AmazonRootCA1.pem"
PATH_TO_PRIVATE_KEY = "certs/device.private.key"  # Substitua pelo nome do seu arquivo
PATH_TO_CERTIFICATE = "certs/device.pem.crt"    # Substitua pelo nome do seu arquivo
